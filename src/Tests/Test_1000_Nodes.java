...
class Test_1000_Nodes {
    ...
    @Test
    void save() {
        assertEquals(true,algo.save("1000NodesTest.json"));
    ...
    void load() {
        ...
        assertEquals(true,algo.load("C:\\Users\\ROG Strix\\IdeaProjects\\Ex2\\1000NodesTest.json"));
