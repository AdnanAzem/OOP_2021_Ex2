...
public class Test_10000_Nodes {
    ...
    public  Test_10000_Nodes(){
        ...
        for (int i=9900, j=0;  i<10000 ; i++ ,j++) {
            //1
            src=i;
            dest=j+1;
            w=random.nextDouble(1,2);
    ...
    @Test
    void save() {
        assertEquals(true,algo.save("10000NodesTest.json"));
    ...
    void load() throws FileNotFoundException {
        ...
        assertEquals(true,algo.load("C:\\Users\\ROG Strix\\IdeaProjects\\Ex2\\10000NodesTest.json"));
